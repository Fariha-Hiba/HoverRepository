...
- Location: C:\PlaywrightTrainingAscendion\tests\PagingWebTable.spec.js:3:5
...
Expected: 5
Received: 4
    at C:\PlaywrightTrainingAscendion\tests\PagingWebTable.spec.js:16:33
```
...
- table:
  - rowgroup:
    - row "Name CPU (%) Disk (MB/s) Memory (MB) Network (Mbps)":
      ...
      - cell "Network (Mbps)"
  - rowgroup:
    - row "Firefox 8.3% 0.67 MB/s 41.5 MB 4.8 Mbps":
      - cell "Firefox"
      - cell "8.3%"
      - cell "0.67 MB/s"
      - cell "41.5 MB"
      - cell "4.8 Mbps"
    - row "Chrome 8.7% 0.30 MB/s 36.8 MB 2.9 Mbps":
      - cell "Chrome"
      - cell "8.7%"
      - cell "0.30 MB/s"
      - cell "36.8 MB"
      - cell "2.9 Mbps"
    - row "Internet Explorer 7.5% 0.95 MB/s 47.4 MB 6.6 Mbps":
      - cell "Internet Explorer"
      - cell "7.5%"
      - cell "0.95 MB/s"
      - cell "47.4 MB"
      - cell "6.6 Mbps"
    - row "System 4.6% 0.52 MB/s 51.8 MB 5.7 Mbps":
      - cell "System"
      - cell "4.6%"
      - cell "0.52 MB/s"
      - cell "51.8 MB"
...
```ts
   ...
   5 |
   6 |     console.log("Total number of rows and columns")
   7 |
   8 |     const table =  page.locator("//table[@id='productTable']")
   9 |     const columns = page.locator("//table[@id='productTable']//th")
  10 |     console.log("No. of columns: ", await columns.count)
  11 |     expect (await columns.count()).toBe(4)
  12 |
  13 |
  14 |     const rows = page.locator("//table[@id='productTable']//th")
  15 |     console.log("No. of rows: ", await rows.count)
