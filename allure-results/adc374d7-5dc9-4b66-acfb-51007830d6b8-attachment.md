...
- Name: Spicejet Datepicker Test
- Location: C:\PlaywrightTrainingAscendion\tests\Spicejet.spec.js:3:5

# Error details

```
Error: locator.click: Unexpected token "/" while parsing css selector "https://www.spicejet.com/". Did you mean to CSS.escape it?
Call log:
  - waiting for https://www.spicejet.com/

    at C:\PlaywrightTrainingAscendion\tests\Spicejet.spec.js:5:53
```
...
```ts
  ...
  2 |
  3 | test('Spicejet Datepicker Test', async({page}) => {
  4 |     await page.goto('https://www.spicejet.com/')
> 5 |     await page.locator('https://www.spicejet.com/').click()
    |                                                     ^ Error: locator.click: Unexpected token "/" while parsing css selector "https://www.spicejet.com/". Did you mean to CSS.escape it?
  6 |     await page.locator('//*[@id="main-container"]/div/div[1]/div[3]/div[2]/div[4]/div/div[2]/div[2]/div[3]/div[2]/div/div[1]/div/div[3]/div[5]/div[3]').click()
  7 |
  8 |     await expect(page.locator('//*[@id="main-container"]/div/div[1]/div[3]/div[2]/div[4]/div/div[1]/div[1]/div[2]/div[1]')).toHaveText('Wed, 28 May 2025')
  9 | })
```